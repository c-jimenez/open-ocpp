...
#ifndef OPENOCPP_OCPP20_ICENTRALSYSTEMEVENTSHANDLER20_H
#define OPENOCPP_OCPP20_ICENTRALSYSTEMEVENTSHANDLER20_H
...
class ICentralSystemEventsHandler20
{
  public:
    /** @brief Destructor */
    virtual ~ICentralSystemEventsHandler20() { }
     ...
     */
    virtual void chargePointConnected(std::shared_ptr<ICentralSystem20::IChargePoint20> chargepoint) = 0;
};
...
#endif // OPENOCPP_OCPP20_ICENTRALSYSTEMEVENTSHANDLER20_H
