...
bool SetMonitoringDataType20Converter::fromJson(const rapidjson::Value&       json,
...
bool SetMonitoringDataType20Converter::toJson(const SetMonitoringDataType20& data, rapidjson::Document& json)
{
    bool ret = true;
