...
bool UnitOfMeasureType20Converter::fromJson(const rapidjson::Value&       json,
...
bool UnitOfMeasureType20Converter::toJson(const UnitOfMeasureType20& data, rapidjson::Document& json)
{
    bool ret = true;
