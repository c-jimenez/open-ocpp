...
#ifndef OPENOCPP_CUSTOMERINFORMATIONSTATUSENUMTYPE_H
#define OPENOCPP_CUSTOMERINFORMATIONSTATUSENUMTYPE_H
...
#endif // OPENOCPP_CUSTOMERINFORMATIONSTATUSENUMTYPE_H