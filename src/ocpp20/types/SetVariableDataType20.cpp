...
bool SetVariableDataType20Converter::fromJson(const rapidjson::Value&       json,
...
bool SetVariableDataType20Converter::toJson(const SetVariableDataType20& data, rapidjson::Document& json)
{
    bool ret = true;
