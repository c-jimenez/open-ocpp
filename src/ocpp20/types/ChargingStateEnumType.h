...
#ifndef OPENOCPP_CHARGINGSTATEENUMTYPE_H
#define OPENOCPP_CHARGINGSTATEENUMTYPE_H
...
/** @brief Transaction. State. Transaction_ State_ Code
...
#endif // OPENOCPP_CHARGINGSTATEENUMTYPE_H