...
bool GetVariableResultType20Converter::fromJson(const rapidjson::Value&       json,
                                                ...
                                                [[maybe_unused]] std::string& error_message)
{
    ...
    // attributeStatus
    data.attributeStatus = GetVariableStatusEnumType20Helper.fromString(json["attributeStatus"].GetString());
...
bool GetVariableResultType20Converter::toJson(const GetVariableResultType20& data, rapidjson::Document& json)
{
    bool ret = true;
    ...
    // attributeStatus
    fill(json, "attributeStatus", GetVariableStatusEnumType20Helper.toString(data.attributeStatus));
