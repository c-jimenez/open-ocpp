...
#ifndef OPENOCPP_CUSTOMERINFORMATION_H
#define OPENOCPP_CUSTOMERINFORMATION_H
...
#include "CustomerInformationStatusEnumType.h"
...
#endif // OPENOCPP_CUSTOMERINFORMATION_H