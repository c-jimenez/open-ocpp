...
#ifndef OPENOCPP_ILOCALCONTROLLEREVENTSHANDLER_H
#define OPENOCPP_ILOCALCONTROLLEREVENTSHANDLER_H
...
class ILocalControllerEventsHandler
{
  public:
     ...
     */
    virtual void chargePointConnected(std::shared_ptr<IChargePointProxy> chargepoint) = 0;
};

} // namespace localcontroller
} // namespace ocpp

#endif // OPENOCPP_ILOCALCONTROLLEREVENTSHANDLER_H
